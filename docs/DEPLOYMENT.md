...
**Статус:** приложение развёрнуто, работает на продакшн-домене, вручную протестировано end-to-end (регистрация, логин, шаблоны, КП, версии, PDF). Работа над Phase 8 сознательно приостановлена — базовая инфраструктура готова, оставшиеся пункты (см. чек-лист внизу) не блокируют использование.
