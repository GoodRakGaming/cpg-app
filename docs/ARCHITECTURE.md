...
шаблонов, с версионированием и экспортом в PDF.

Для истории развития проекта и текущего статуса см. [STATUS.md](STATUS.md).
...
ввод, автоматизированный приём документов, будущие уровни сбора данных). Реализовано и работает
в проде; `ingest-runs` (таблица метрик автоматизированного приёма) — часть следующего этапа, ещё
не собрана.
